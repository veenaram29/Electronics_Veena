...
CapacitiveSensor   cs_12_10 = CapacitiveSensor(12,10);    // 10M resistor between pins 4 & 8, pin 8 is sensor pin, add a wire and or foil
...
void loop()                    
{
    ...
    long total3 =  cs_12_10.capacitiveSensor(30);
